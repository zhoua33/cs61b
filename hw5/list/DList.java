...
public class DList extends List {
   ...
   **/
  public DList() {
    head = this.newNode(null,null,head,head);
    head.next = head;
    head.prev = head;
    size = 0;
  ...
  public void insertFront(Object item) {
	...
	DListNode newnode = this.newNode(item,this,sentinel,sentinel);
	sentinel.prev = newnode;
	sentinel.next = newnode;
    }else{
	DListNode sentinel = head;
	DListNode newnode = this.newNode(item,this,sentinel,sentinel.next);
  ...
  public void insertBack(Object item) {
    if(!isEmpty()){
	DListNode sentinel = head;
	DListNode newnode = this.newNode(item,this,sentinel.prev,sentinel);
